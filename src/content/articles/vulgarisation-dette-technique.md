...
La dette technique a un problème d’image.

Dans beaucoup d’entreprises, elle reste rangée dans la colonne “sujet d’ingénieurs”. Une affaire d’architecture, de code legacy, de refactoring, de backlog interne. Quelque chose de réel, certes, mais secondaire tant que le produit avance, que les ventes tombent et que l’équipe continue à livrer.

C’est une lecture commode. Elle est aussi souvent fausse.
...
Pas dans un sens théorique. Dans un sens très concret.
...
À ce stade, continuer à parler de “dette technique” comme d’un sujet purement interne est une erreur de vocabulaire. On ne parle plus seulement de maintenance. On parle d’un système qui absorbe de l’énergie à chaque mouvement.
...
Rien de spectaculaire. Juste une série de compromis.

C’est d’ailleurs ce qui rend le sujet si mal piloté. La dette technique ne ressemble pas forcément à une crise. Au départ, elle ressemble à du pragmatisme. Elle donne même parfois l’impression d’avoir aidé la boîte à aller plus vite.

Et c’est vrai, jusqu’à un certain point.

Le problème n’est pas qu’elle existe. Dans un SaaS vivant, une part de dette est normale. Le problème est le moment où elle commence à déformer les décisions, ralentir le produit, rendre le système plus fragile et faire payer à l’entreprise, en vitesse perdue et en clarté stratégique, ce qu’elle croyait n’avoir économisé qu’en temps de développement.
...
La dette technique n’est pas simplement du mauvais code. Ce serait trop simple. Un produit peut contenir du code imparfait sans être gravement freiné. Inversement, un système apparemment propre peut déjà être en train de devenir rigide, coûteux à faire évoluer ou dangereux à toucher.
...
C’est pour cela qu’elle échappe si souvent aux lectures trop superficielles. Une équipe peut encore livrer. Le produit tourne. Les clients paient. Vu de l’extérieur, rien ne semble catastrophique.

Mais en interne, chaque nouvelle demande déclenche une série de frictions :

- il faut vérifier trois dépendances cachées ;
...
Les équipes produit ou business ont l’impression que les délais se dégradent. Pas parce que les ambitions ont explosé, ni parce que l’équipe serait soudain moins compétente, mais parce que chaque livraison demande plus de contournements, plus de vérifications, plus de coordination, plus de prudence.

Une fonctionnalité simple sur le papier devient pénible à sortir. Non parce qu’elle est conceptuellement compliquée, mais parce que le système dans lequel elle doit entrer n’est plus assez propre pour l’accueillir sereinement.

C’est là que le discours “on manque de vitesse” devient trompeur.

Le problème n’est pas forcément la vitesse des équipes. Le problème est le frottement structurel du produit.
...
Tant que la dette est regardée comme un poste de maintenance, elle perd l’arbitrage. Dès qu’on la relit comme un frein sur les prochaines options de croissance, la discussion devient plus sérieuse.
...
À partir de là, la dette technique n’est plus un enjeu de backlog. C’est une dégradation opérationnelle.
...
Évidemment, il existe des cas où l’argument technique sert à repousser des décisions ou à défendre une forme de perfectionnisme improductif. Mais l’erreur inverse est fréquente aussi : traiter toute alerte sur la dette comme une préférence d’ingénieur, alors qu’il s’agit parfois d’un signal sérieux sur la capacité future du produit.
...
Le bon objectif n’est pas de retrouver un système parfait. Le bon objectif est de récupérer de la capacité de mouvement là où le produit en a le plus besoin.
...
Cette différence de cadrage est essentielle.

Elle évite deux erreurs classiques :
...
À ce moment-là, continuer à traiter le sujet comme un enjeu interne de développement est une faute de lecture.

La dette technique n’est plus un détail d’implémentation. Elle devient une limite de système.
